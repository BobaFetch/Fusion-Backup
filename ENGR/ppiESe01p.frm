...
'3/1/06 Added Color for PROPLA
'5/18/06 Option combos and passed Part Number
'6/1/06 changed focus of New Part Number
Option Explicit
Dim bCancel As Byte
Dim bOnLoad As Byte
...
Private Function CheckPart() As Byte
   ...
   sSql = "SELECT PARTREF,PARTNUM,PADESC,PALEVEL,PAMAKEBUY," _
          & "PAPRODCODE,PAMATERIALTYPE,PAMATERIALALLOY,PACOLOR " _
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   If optQwik.value = vbChecked Then ppiESe01a.optPart.value = vbUnchecked
   On Error Resume Next
   If optQwik.value = vbChecked Then
      ppiESe01a.txtPrt.SetFocus
   Else
      ppiESe02a.txtPrt.SetFocus
   End If
...
Private Sub AddNewPart()
   ...
   If bResponse = vbYes Then
      ...
      sSql = "INSERT INTO PartTable (PARTREF,PARTNUM,PADESC,PALEVEL,PAMAKEBUY," _
             ...
             & "','" & txtMatType & "','" & txtMatAlloy & "','" & txtColor & "') "
      ...
      If Err = 0 Then
         ...
         If optClose.value = vbChecked Then
            If optQwik.value = vbChecked Then
               ppiESe01a.txtPrt.Text = txtPrt
               ppiESe01a.txtPrt.ToolTipText = txtDsc & "     "
               ppiESe01a.SetFocus
            Else
               ppiESe02a.txtPrt.Text = txtPrt
               ppiESe02a.txtPrt.ToolTipText = txtDsc & "     "
               ppiESe02a.SetFocus
            End If
            txtPrt = ""
            txtDsc = ""
...
Private Sub FillCombos()
   ...
   sSql = "SELECT DISTINCT PACOLOR FROM PartTable"
   LoadComboBox txtColor, -1
   If txtColor.ListCount > 0 Then txtColor = txtColor.List(0)
