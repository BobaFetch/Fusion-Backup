...
Begin VB.Form ppiESe02f 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Estimating Formula"
   ClientHeight    =   4320
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6030
   ...
   Begin VB.CommandButton cmdUpd 
      ...
      Left            =   5040
      TabIndex        =   5
      ToolTipText     =   "Apply And Insert Into Routing"
      Top             =   2160
      Width           =   852
   End
...
Private Sub cmdUpd_Click()
   If Val(txtTotal) > 0 Then
      On Error Resume Next
      ppiESe02b.txtDsc = txtDsc
      ppiESe02b.txtCost = Format(Val(txtTotal), "####0.00")
      ppiESe02b.txtCost.SetFocus
      Unload Me
   Else
      MsgBox "Nothing To Apply..", vbInformation, "Estimating"
   End If
...
Private Sub txtTotal_Change()
   If Val(txtTotal) > 0 Then cmdUpd.Enabled = True
