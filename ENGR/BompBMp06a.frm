...
Begin VB.Form BompBMp06a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "List of Released Parts Lists"
   ClientHeight    =   3360
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   7245
   ...
   Begin VB.CommandButton cmdFnd 
      DownPicture     =   "BompBMp06a.frx":07AE
      Height          =   315
      Left            =   5280
      Picture         =   "BompBMp06a.frx":0AF0
      Style           =   1  'Graphical
      TabIndex        =   14
      TabStop         =   0   'False
...
Private Sub PrintReport()
   ...
   sCustomReport = GetCustomReport("engbm06")
   ...
   sSql = "{BmhdTable.BMHREF} LIKE '" & sPart & "*' AND " _
          & "({BmhdTable.BMHRELEASEDATE} in Date(" & sBegDate & ") " _
          & "to Date(" & sEndDate & ") AND {BmhdTable.BMHRELEASED}=1)"
...
Private Sub SaveOptions()
   ...
   SaveSetting "Esi2000", "EsiEngr", "pl06", sOptions
...
Private Sub GetOptions()
   Dim sOptions As String
   On Error Resume Next
   sOptions = GetSetting("Esi2000", "EsiEngr", "pl06", sOptions)
