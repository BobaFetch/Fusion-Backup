...
Private Sub AddBid()
   ...
   If bResponse = vbYes Then
      ...
      If Err = 0 Then
         ...
         ppiESe02a.cmbBid.AddItem txtBid
         ppiESe02a.cmbBid = txtBid
         bGoodBid = ppiESe02a.GetThisPPIFullBid(True)
