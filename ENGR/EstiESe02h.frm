...
Begin VB.Form EstiESe02h 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "New Full Estimate"
   ClientHeight    =   2445
   ClientLeft      =   30
   ClientTop       =   330
   ClientWidth     =   5685
...
Private Sub AddBid()
   ...
   If bResponse = vbYes Then
      ...
      If clsADOCon.ADOErrNum = 0 Then
         ...
         SysMsg "Esimate " & txtBid & " Was Added.", True
         On Error Resume Next
         EstiESe02a.cmbBid.AddItem txtBid
         EstiESe02a.cmbBid = txtBid
         bGoodBid = EstiESe02a.GetThisFullBid(True)
