...
Private Sub AddBid()
   ...
   If bResponse = vbYes Then
      ...
      If clsADOCon.ADOErrNum = 0 Then
         ...
         EstiESe01a.cmbBid.AddItem txtBid
         EstiESe01a.cmbBid = txtBid
         bGoodBid = EstiESe01a.GetThisQBid(True)
