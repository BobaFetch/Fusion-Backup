...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   If bBadRow = 1 Then
      ...
      If bResponse = vbNo Then
         Cancel = True
      Else
         'bResponse = GetBidServices(ppiESe02a)
         bResponse = GetBidServices(ppiESe02a, CCur("0" & ppiESe02a.txtQty))
      End If
   Else
      'bResponse = GetBidServices(ppiESe02a)
      bResponse = GetBidServices(ppiESe02a, CCur("0" & ppiESe02a.txtQty))
   ...
   If bSqlRows Then
      With RdoOsp
         Do Until .EOF
            ...
            txtCst(!BIDOSROW) = Format(!BIDOSTOTALCOST, "###0.00")
...
Private Sub txtCst_LostFocus(Index As Integer)
   ...
   txtCst(Index) = Format(Abs(Val(txtCst(Index))), "####0.00")
