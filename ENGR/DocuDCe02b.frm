...
Begin VB.Form DocuDCe02b 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "DocumentList  Change Revision"
   ClientHeight    =   2190
   ClientLeft      =   2985
   ClientTop       =   2310
   ClientWidth     =   7155
...
Private Sub cmdAppy_Click()
   ...
   Else
      DocuDCe02a.cmbRev = txtRev
      DocuDCe02a.txtCmt = txtCmt
      DocuDCe02a.chkUpChild = 1
      Unload Me
...
Private Sub cmdCan_Click()
   DocuDCe02a.cmbRev = txtPrevRev
   DocuDCe02a.chkUpChild = 0
   Unload Me
