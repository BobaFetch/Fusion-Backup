...
Begin VB.Form EstiESf01a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Mark An Estimate As Not Accepted"
   ClientHeight    =   2970
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5730
...
Private Sub cmdCbd_Click()
   ...
   sMsg = "This Function Marks A Bid Not Accepted." & vbCrLf _
          & "Are You Sure That You Wish Change The Bid Accepted Flag?"
   bResponse = MsgBox(sMsg, ES_YESQUESTION, Caption)
   If bResponse = vbYes Then
      On Error Resume Next
      clsADOCon.ADOErrNum = 0
      
      sSql = "UPDATE EstiTable SET BIDACCEPTED=0," _
             & "BIDACCEPT=Null " _
             & "WHERE BIDREF=" & Val(cmbBid) & " "
      clsADOCon.ExecuteSQL sSql 'rdExecDirect
      If clsADOCon.ADOErrNum = 0 Then
         MsgBox "Bid Was Successfully Marked Not Accepted.", _
            vbInformation, Caption
         FillCombo
      Else
         MsgBox "Bid Not Was Successfully Marked Not Accepted.", _
...
Private Sub FillCombo()
   ...
   sSql = "SELECT BIDREF,BIDPRE,BIDCANCELED,BIDACCEPTED FROM EstiTable " _
          & "WHERE BIDCANCELED=0 AND BIDACCEPTED=1 ORDER BY BIDREF DESC"
...
Private Function GetTheBid() As Byte
   ...
   sSql = "SELECT BIDREF,BIDNUM,BIDPRE,BIDCLASS,BIDPART,BIDCUST," _
          ...
          & "AND BIDCANCELED=0 AND BIDACCEPTED=1"
