...
Begin VB.Form ToolTLp01a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Tools By Tool Number"
   ClientHeight    =   3525
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   7215
...
Private Sub PrintReport()
   ...
   cCRViewer.Init
   sCustomReport = GetCustomReport("engtl01")
   cCRViewer.SetReportFileName sCustomReport, sReportPath
   cCRViewer.SetReportTitle = sCustomReport
   
   sSql = "UpperCase({TohdTable.TOOL_CLASS}) LIKE '" & sClass & "*' " _
          & "AND {TohdTable.TOOL_PARTREF} LIKE '" & sPart & "*' "
...
Private Sub SaveOptions()
   ...
   SaveSetting "Esi2000", "EsiEngr", "tl01", sOptions
   
End Sub

Private Sub GetOptions()
   Dim sOptions As String
   sOptions = Trim(GetSetting("Esi2000", "EsiEngr", "tl01", sOptions))
   On Error Resume Next
...
Private Sub FillTools()
   ...
   sSql = "SELECT TOOL_NUM FROM TohdTable WHERE TOOL_CLASS LIKE '" _
