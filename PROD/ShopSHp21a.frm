...
Begin VB.Form ShopSHp21a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Work Center Queue List Stats"
   ClientHeight    =   4095
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   7155
...
Private Sub PrintReport()
   ...
   If optHis(1).Value = True Then
      sCustomReport = GetCustomReport("prdsh21b")
   Else
      sCustomReport = GetCustomReport("prdsh21")
   End If
   ...
   aRptPara.Add CStr(sBDate)
   aRptPara.Add CStr(sEDate)
   aRptPara.Add CStr(sShop)
   aRptPara.Add CStr(sCenter)
