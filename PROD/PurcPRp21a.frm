...
Begin VB.Form PurcPRp21a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Purchase Order History By Vendor to Date Costing"
   ClientHeight    =   5490
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   7230
   ...
   Begin VB.ComboBox cmbFilterBy 
      Height          =   315
      ItemData        =   "PurcPRp21a.frx":0000
      Left            =   2160
      List            =   "PurcPRp21a.frx":000A
   ...
   Begin VB.CommandButton cmdFnd 
      DownPicture     =   "PurcPRp21a.frx":07D4
      Height          =   315
      Left            =   6720
      Picture         =   "PurcPRp21a.frx":0B16
      Style           =   1  'Graphical
      TabIndex        =   31
      TabStop         =   0   'False
...
Private Sub PrintReport()
   ...
   On Error GoTo DiaErr1
    ...
    cCRViewer.Init
    sCustomReport = GetCustomReport("prdpr21")
 '  MDISect.Crw.ReportFileName = sReportPath & sCustomReport
   ...
   aRptPara.Add CStr(txtPrt)
   aRptPara.Add CStr(cmbCls)
   aRptPara.Add CStr(cmbCde)
   aRptPara.Add CStr(Me.cmbFilterBy.ListIndex)
   aRptPara.Add CStr(optT14.Value)
   aRptPara.Add CStr(optT15.Value)
   aRptPara.Add CStr(optT16.Value)
   aRptPara.Add CStr(optT17.Value)
