...
Begin VB.Form ShopSHp24 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Priority Dispatch Report"
   ClientHeight    =   2250
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   6930
   ...
   Begin Threed.SSRibbon cmdHlp 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "shopshp24.frx":0308
      PictureDn       =   "shopshp24.frx":044E
   End
   ...
   Begin Threed.SSRibbon ShowPrinters 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "shopshp24.frx":0594
      PictureDn       =   "shopshp24.frx":06DA
   End
   Begin VB.Label z1 
...
Private Sub PrintReport()
   ...
   aFormulaValue.Add CStr("'Priority Dispatch Report for " & CStr(Trim(txtBeg)) & " through " & Trim(txtEnd) & "'")

   sCustomReport = GetCustomReport("prdsh24.rpt")
