...
Begin VB.Form VewAcct
   ...
   Begin ResizeLibCtl.ReSize ReSize1
      ...
      FormMinWidth = 0
      FormMinHeight = 0
      FormDesignHeight = 3924
      FormDesignWidth = 4464
   End
...
Private Sub Form_QueryUnload(Cancel As Integer, UnloadMode As Integer)
   ...
   diaSLe03a.optVewAcct = vbUnchecked
...
Private Sub FillAccounts()
   ...
   If Len(sAcctRef) > 0 Then
      ...
      sSql = "SELECT GLACCTREF,GLACCTNO,GLDESCR " _
             & "FROM GlacTable WHERE GLACCTREF Like '" & sAcctRef & "%' "
      bSqlRows = GetDataSet(RdoRns)
      If bSqlRows Then
         With RdoRns
            Do Until .EOF
               iList = iList + 1
...
Private Sub FillDescriptions()
   ...
   If Len(sAcctRef) > 0 Then
      ...
      bSqlRows = GetDataSet(RdoRns, ES_FORWARD)
      If bSqlRows Then
         With RdoRns
            Do Until .EOF
               iList = iList + 1
