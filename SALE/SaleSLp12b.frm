...
Begin VB.Form SaleSLp12b 
   ...
   Begin VB.CommandButton optPrn 
      DownPicture     =   "SaleSLp12b.frx":030A
      Height          =   415
      Left            =   8520
      Picture         =   "SaleSLp12b.frx":0494
      Style           =   1  'Graphical
      TabIndex        =   1
      TabStop         =   0   'False
...
'9/7/06 New
'3/27/07 Fixed Control Array error in CreateCustChart 7.3.3
Option Explicit
...
Private Sub Form_Load()
   ...
   For iRow = 0 To 19
      ...
      Sales(iRow).ToolTipText = "Total Shipments For This Customer"
   Next
   bOnLoad = 1
...
Private Sub CreateTempTable()
   ...
   sSql = "select DISTINCT SOCUST,CUNAME,ITSO FROM SohdTable,CustTable," _
          & "SoitTable WHERE (SONUMBER=ITSO AND ITACTUAL Between '" & sBeg & " 00:00' " _
          & "AND '" & sEnd & " 23:59' AND ITPSSHIPPED=1 AND SOCUST=CUREF) AND " _
...
Private Sub CreateCustChart()
   ...
   For iRow = 0 To iTotalCusts
      sSql = "SELECT SOCUST,SONUMBER,SUM(ITQTY*ITDOLLARS)AS CustSales FROM " _
             ...
             & "ITACTUAL BETWEEN '" & sBeg & " 00:00' AND '" & sEnd & " 23:59' " _
             & "AND ITPSSHIPPED=1 AND SOCUST='" & sCustomers(iRow, 0) & "') " _
