...
Begin VB.Form zGr5Matl 
   ...
   ClientWidth     =   4920
   ControlBox      =   0   'False
   Icon            =   "Gr5Matl.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "Gr5Matl.frx":08CA
   ScaleHeight     =   4515
   ScaleWidth      =   4920
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Matl.frx":1194
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Matl.frx":174A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Matl.frx":1B54
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Matl.frx":1CB2
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   3
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Matl.frx":1F13
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Matl.frx":23C2
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Matl.frx":2863
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub FillEdit()
   ActiveTab = "E"
   lstSelect.Clear
   If Secure.UserAdmnG5E = 1 Then
      'If User.Group5 Then
      lstSelect.AddItem "Parts "
      lstSelect.AddItem "Part Locations (Inventory)"
      lstSelect.AddItem "Inventory ABC Classes"
      lstSelect.AddItem "Inventory ABC Class Setup"
      lstSelect.AddItem "Standard Cost"
      lstSelect.AddItem "Workstation Lot Locations"
...
Public Sub FillFunctions()
   ActiveTab = "F"
   lstSelect.Clear
   If Secure.UserAdmnG5F = 1 Then
      'If User.Group5 Then
      lstSelect.AddItem "Update Inventory Activity Standard Costs"
      lstSelect.AddItem "Recost Purchase Orders"                     '5
      lstSelect.AddItem "Recost Manufacturing Orders"                '6
      lstSelect.AddItem "Recost Shipments"                           '7
      lstSelect.Enabled = True
      'Else
      '    lstSelect.Enabled = False
      '    lstSelect.AddItem "No Group Permissions"
