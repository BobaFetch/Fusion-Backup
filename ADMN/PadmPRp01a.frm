...
Begin VB.Form PadmPRp01a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Product Codes Report"
   ClientHeight    =   2535
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   7260
...
Private Sub PrintReport1()
   ...
   MDISect.Crw.Formulas(1) = "Includes='Includes Term(s) " & cmbCde & "... '"
   ...
   End If
   MDISect.Crw.SelectionFormula = "{PcodTable.PCREF} Like '" & sPerson & "*' "
   'SetCrystalAction Me
   MouseCursor 0
   Exit Sub
...
Private Sub SaveOptions()
   ...
   SaveSetting "Esi2000", "EsiAdmn", "pr01", sOptions
...
Private Sub GetOptions()
   ...
   sOptions = GetSetting("Esi2000", "EsiAdmn", "pr01", sOptions)
