...
Begin VB.Form zGr3Padm 
   ...
   ClientWidth     =   4920
   ControlBox      =   0   'False
   Icon            =   "Gr3Padm.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "Gr3Padm.frx":08CA
   ScaleHeight     =   4515
   ScaleWidth      =   4920
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr3Padm.frx":1194
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr3Padm.frx":174A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr3Padm.frx":1B54
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr3Padm.frx":1CB2
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   3
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr3Padm.frx":1F13
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr3Padm.frx":23C2
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr3Padm.frx":2863
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub FillEdit()
   ActiveTab = "E"
   lstSelect.Clear
   If Secure.UserAdmnG3E = 1 Then
      'If User.Group3 Then
      lstSelect.AddItem "Product Codes "
      lstSelect.AddItem "Product Classes "
...
Private Sub FillView()
   ActiveTab = "V"
   lstSelect.Clear
   If Secure.UserAdmnG3V = 1 Then
      'If User.Group3 Then
      lstSelect.AddItem "Product Codes Report "
      lstSelect.AddItem "Product Classes Report "
      lstSelect.Enabled = True
      'Else
      '    lstSelect.Enabled = False
      '    lstSelect.AddItem "No Group Permissions"
...
Public Sub FillFunctions()
   ActiveTab = "F"
   lstSelect.Clear
   If Secure.UserAdmnG3F = 1 Then
      'If User.Group3 Then
      lstSelect.AddItem "Delete A Product Code "
      lstSelect.AddItem "Change Product Codes "
      lstSelect.AddItem "Update Product Codes or Classes "
      lstSelect.AddItem "Delete A Product Class "
      lstSelect.AddItem "Change Product Classes "
      lstSelect.AddItem "Update Product Classes By Part Type "
      lstSelect.Enabled = True
      'Else
      '    lstSelect.Enabled = False
      '    lstSelect.AddItem "No Group Permissions"
