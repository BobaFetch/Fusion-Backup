...
Private Sub cmdOk_MouseDown(Button As Integer, Shift As Integer, X As Single, Y As Single)
   If Button = 2 Then
      ...
      SubjHelp.Left = Esi2000h.Left + 100
      SubjHelp.Show
