...
Begin VB.Form diaJRf05a
   ...
   Begin Threed.SSRibbon cmdHlp
      ...
      BevelWidth = 0
      Outline = 0 'False
      PictureUp = "diaJrnOpenClosed.frx":0000
      PictureDn = "diaJrnOpenClosed.frx":0146
   End
...
'***********************************************************************************
'
' diaJRf05a - Reopen a closed journal.
'
'
'
'************************************************************************************
...
Private Sub OpenJrn()
   ...
   Dim smsg As String
   Dim sJrn As String
   Dim rdoOpn As rdoResultset
   
   On Error GoTo DiaErr1
   
   sJrn = Grid1.Text
   smsg = "Open Journal " & sJrn & " ?"
   ...
   If bResponse = vbYes Then
      ...
      If Err = 0 Then
         RdoCon.CommitTrans
         Sysmsg "Journal Was Successful Opened.", 1
         FillJournals
      Else
         RdoCon.RollbackTrans
         smsg = "Could Not Reopen Journal." & vbCrLf & "Transaction Canceled."
...
Private Sub FillJournals()
   ...
   sSql = "SELECT MJGLJRNL, MJDESCRIPTION, MJSTART, MJEND " _
          ...
          & "(MJTYPE = '" & lblTyp & "') AND (MJCLOSED IS NOT NULL)"
