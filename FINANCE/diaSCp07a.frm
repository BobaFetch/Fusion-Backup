...
Begin VB.Form diaSCp07a 
   ...
   Begin Threed.SSRibbon cmdHlp 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "diaSCp07a.frx":064A
      PictureDn       =   "diaSCp07a.frx":0790
   End
   Begin Threed.SSRibbon ShowPrinters 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "diaSCp07a.frx":08D6
      PictureDn       =   "diaSCp07a.frx":0A1C
   End
   Begin VB.Label z1 
   ...
   Begin VB.Label z1 
      BackStyle       =   0  'Transparent
      Caption         =   "Include Items With Costs Updated:"
      Height          =   285
      Index           =   2
      Left            =   120
      TabIndex        =   47
...
Private Sub PrintReport()
   ...
   sCustomReport = GetCustomReport("finsc07")
   ...
   sDate = "Include Only Parts Updated From   "
   If Trim(txtBeg) <> "" Then
      sSql = sSql & "AND {@REVDATE} >= cdate('" & txtBeg & "') "
      sDate = sDate & txtBeg & "    "
   Else
      sDate = sDate & "           "
   End If
   ...
   If Trim(txtEnd) <> "" Then
      sSql = sSql & "AND {@REVDATE} <= cdate('" & txtEnd & "') "
      sDate = sDate & "Through   " & txtEnd
   Else
      sDate = sDate & "Through        "
   End If
    ...
    aFormulaName.Add "Title5"
    
    aFormulaValue.Add CStr("'" & CStr(sFacility) & "'")
    aFormulaValue.Add CStr("'Current Standard Vs. Previous'")
    ...
    aFormulaValue.Add CStr("'" & CStr(sDate) & "'")
...
Private Sub PrintReport1()
   ...
   MdiSect.crw.Formulas(1) = "Title1='Current Standard Vs. Previous'"
   ...
   MdiSect.crw.Formulas(9) = "title5 ='" & sDate & "'"
