...
Begin VB.Form diaJCp04a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "MO Detail Cost Summary"
   ClientHeight    =   2430
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   7260
   ...
   Begin Threed.SSRibbon cmdHlp 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "diaJCp04a.frx":0308
      PictureDn       =   "diaJCp04a.frx":044E
   End
   Begin Threed.SSRibbon ShowPrinters 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "diaJCp04a.frx":0594
      PictureDn       =   "diaJCp04a.frx":06DA
   End
...
'************************************************************************************
'
' diaJCp04a - MO Cost Analysis Report
'
' Created: (cjs)
' Revisions:
...
Public Sub GetStatusRun()
   ...
   bSqlRows = clsADOCon.GetDataSet(sSql, RdoStu)
...
'   Dim RdoRns As rdoResultset
  ...
  ' bSqlRows = GetQuerySet(RdoRns, rdoQry)
   bSqlRows = clsADOCon.GetQuerySet(RdoRns, rdoQry, ES_KEYSET, True)
...
'   aFormulaValue.Add CStr("'" & lblQty & "'")
   ...
   sCustomReport = GetCustomReport("finAllMOCost.rpt")
