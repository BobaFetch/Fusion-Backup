...
Begin VB.Form diaAPp02b 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Vendor Statements (Report)"
   ClientHeight    =   3225
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   6930
   ...
   Begin Threed.SSRibbon cmdHlp 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "diaAPp02b.frx":0000
      PictureDn       =   "diaAPp02b.frx":0146
   End
   ...
   Begin Threed.SSRibbon ShowPrinters 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "diaAPp02b.frx":028C
      PictureDn       =   "diaAPp02b.frx":03D2
   End
...
Private Sub PrintReport()
   ...
   ' report parameter
   aRptParaType.Add CStr("String")  'parameter 1 = @Vendor
   aRptParaType.Add CStr("String")  'parameter 2 = @StartDate
   aRptParaType.Add CStr("String")  'parameter 3 = @EndDate
   aRptParaType.Add CStr("Bool")    'parameter 4 = @IncludePaidInvoices
   aRptPara.Add CStr(cmbVnd)
   aRptPara.Add CStr(txtBeg)
   aRptPara.Add CStr(txtEnd)
   aRptPara.Add CStr(optPad.Value)

   
   sCustomReport = GetCustomReport("finap02b.rpt")
