...
Begin VB.Form SalesAnalysys 
   ...
   Begin VB.Frame fraPrn 
      ...
      Begin VB.CommandButton optDis 
         Height          =   330
         Left            =   0
         Picture         =   "SalesAnalysis.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   5
      ...
      Begin VB.CommandButton optPrn 
         Height          =   330
         Left            =   560
         Picture         =   "SalesAnalysis.frx":017E
         Style           =   1  'Graphical
         TabIndex        =   6
   ...
   Begin Threed.SSRibbon cmdHlp 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "SalesAnalysis.frx":0308
      PictureDn       =   "SalesAnalysis.frx":044E
   End
   ...
   Begin Threed.SSRibbon ShowPrinters 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "SalesAnalysis.frx":0594
      PictureDn       =   "SalesAnalysis.frx":06DA
   End
   Begin VB.Label z1 
   ...
   End
End
Attribute VB_Name = "SalesAnalysys"
...
'************************************************************************************
' Form: Sales Analysis - Sales Analysis Report Generator
'
' Created: 6/4/05 - TEL
'
'************************************************************************************
...
Dim bOnLoad As Byte
Dim bCancel As Byte
Public FileName As String 'Crystal Reports filename
...
Private Sub PrintReport()
   ...
   'MdiSect.crw.Formulas(1) = "Begin=#" & txtBeg & "#"
   'MdiSect.crw.Formulas(2) = "End=#" & txtEnd & "#"
   'MdiSect.crw.Formulas(1) = "StartDate=Date(" & Format(txtBeg, "yyyy,mm,dd") & ")"
   'MdiSect.crw.Formulas(2) = "EndDate=Date(" & Format(txtEnd, "yyyy,mm,dd") & ")"
   'MdiSect.crw.Formulas(2) = "End=#" & txtEnd & "#"
   
   ' ;true is supposed to remove the prompt -- instead it removes the data and retains the prompt
   ' ;false or blank retains the prompt
   'CR 8.5 and later have an EnableParameterPrompting property that can be set false
   'MdiSect.crw.ParameterFields.Add "ADDPRAM1", crStringField
   MdiSect.crw.ParameterFields(0) = "Begin;Date(" & Format(txtBeg, "yyyy,mm,dd") & ");true"
   MdiSect.crw.ParameterFields(1) = "End;Date(" & Format(txtEnd, "yyyy,mm,dd") & ");true"
   MdiSect.crw.ParameterFields(2) = "SelectKey;ABCDE;true"
   'MdiSect.crw.ParameterFields(0) = "Begin;Date(" & Format(txtBeg, "yyyy,mm,dd") & ",00,00,00);FALSE"
   '    MdiSect.crw.ParameterFields(1) = "End;Date(" & Format(txtEnd, "yyyy,mm,dd") & ");True"
   '    MdiSect.crw.ParameterFields(0) = "Begin;Testing123;True"
   
   sCustomReport = GetCustomReport(FileName)
   ...
   'let the report do the selection
