...
Begin VB.Form diaGLe07a
   ...
   Begin Threed.SSRibbon cmdHlp
      ...
      BevelWidth = 0
      Outline = 0 'False
      PictureUp = "diaGlprt.frx":0000
      PictureDn = "diaGlprt.frx":0146
   End
   ...
   Begin TabDlg.SSTab Tab1
      ...
      TabPicture(0) = "diaGlprt.frx":028C
      ...
      TabPicture(1) = "diaGlprt.frx":02A8
...
Public Function GetPart() As Byte
   ...
   RdoQry(0) = sPartRef
   bSqlRows = GetQuerySet(rdoAct, RdoQry, ES_KEYSET)
   If bSqlRows Then
      With rdoAct
         cmbPrt = "" & Trim(!PARTNUM)
         lblDsc = "" & Trim(!PADESC)
...
Public Sub FillAccounts()
   ...
   If bSqlRows Then
      With rdoGlm
         Do Until .EOF
            i = i + 1
            ' txtRev.AddItem "" & Trim(!GLACCTNO)
            ' txtDis.AddItem "" & Trim(!GLACCTNO)
            ' txtInv.AddItem "" & Trim(!GLACCTNO)
            ' txtTrv.AddItem "" & Trim(!GLACCTNO)
            ' txtTcg.AddItem "" & Trim(!GLACCTNO)
            ' txtRej.AddItem "" & Trim(!GLACCTNO)
