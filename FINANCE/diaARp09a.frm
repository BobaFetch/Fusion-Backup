...
Begin VB.Form diaARp09a 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "View A Cash Receipt (Report)"
   ClientHeight    =   3915
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6855
   ...
   Begin VB.ComboBox cmbChkNum 
      Height          =   315
      ItemData        =   "diaARp09a.frx":0000
      Left            =   1800
      List            =   "diaARp09a.frx":0002
      TabIndex        =   17
      Tag             =   "3"
      Top             =   2400
      Width           =   1740
   ...
   Begin Threed.SSRibbon cmdHlp 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "diaARp09a.frx":030C
      PictureDn       =   "diaARp09a.frx":0452
   End
   Begin Threed.SSRibbon ShowPrinters 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "diaARp09a.frx":0598
      PictureDn       =   "diaARp09a.frx":06DE
   End
...
'   MdiSect.Crw.Formulas(4) = "Title3 = 'Customer: " & Trim(cmbCst) & "'"
   ...
   cCRViewer.Init
   sCustomReport = GetCustomReport("finar09.rpt")
...
Private Sub GetCheckNumber()
    ...
    sChkSQL = sChkSQL & " order by CACHECKNO"
