...
Begin VB.Form diaJRf05a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Open Closed Journals"
   ClientHeight    =   4800
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6480
   ...
   Begin Threed.SSRibbon cmdHlp 
      ...
      BevelWidth      =   0
      Outline         =   0   'False
      PictureUp       =   "diaJRf05a.frx":0000
      PictureDn       =   "diaJRf05a.frx":0146
   End
...
'***********************************************************************************
'
' diaJRf05a - Opened Closed Journals
'
' Created (nth)
' Revisons
...
Private Sub OpenJrn()
   ...
   If bResponse = vbYes Then
      For i = 1 To Grid1.Rows - 1
         'Grid1.Row = i
         'Grid1.Col = 1
         sJrn = Grid1.TextMatrix(i, 1)

         If bChecks(i) Then
            On Error Resume Next
            clsADOCon.BeginTrans
            clsADOCon.ADOErrNum = 0
            sSql = "UPDATE JrhdTable SET MJCLOSED = Null WHERE MJGLJRNL ='" & sJrn & "'"
            ...
            If Left(sJrn, 3) = "IJ-" Then
               ...
               sSql = sSql & "where INGLJOURNAL = '" & sJrn & "'"
               clsADOCon.ExecuteSQL sSql
            End If
            
            If clsADOCon.ADOErrNum = 0 Then
               clsADOCon.CommitTrans
               sOpen = sOpen & sJrn & vbCrLf
            Else
               clsADOCon.RollbackTrans
               clsADOCon.ADOErrNum = 0
               sNotOpen = sNotOpen & sJrn & vbCrLf
               Err.Clear
            End If
         End If
      Next
      If Trim(sOpen) <> "" Then
         MsgBox "Journals: " & vbCrLf & vbCrLf & sOpen & vbCrLf & "Successfully" _
            & " Opened.", vbInformation, Caption
      End If
      If Trim(sNotOpen) <> "" Then
         MsgBox "Journals: " & vbCrLf & vbCrLf & sNotOpen & vbCrLf & "Were Not" _
            & " Opened.", vbInformation, Caption
      End If
...
Private Sub FillJournals()
   ...
   sSql = "SELECT MJGLJRNL, MJDESCRIPTION, MJSTART, MJEND " _
          ...
          & "(MJTYPE = '" & lblTyp & "') AND (MJCLOSED IS NOT NULL) AND MJFY = " & cmbFyr
