...
Public Sub Main()
   ...
   RdoCon.Connect = "UID=" & strSaAdmin & ";PWD=" & strPW & ";DRIVER={SQL Server};" _
...
'      Loop
   ...
   If (Command <> "") Then
      ...
      ElseIf (arv(0) = "APPEND_EDIFILES") Then
         ...
         strTimeStamp = Format(Now(), "mm-dd-yy.h.mm.ssA/P")
         strOutFile = gstrRawEDIDir & "\" & gstrRawEDIFile
         nOutFNum = FreeFile
         ...
         If EOF(nOutFNum) Then
            ...
            Do While strFileName <> ""
               ...
               If strFileName <> "." And strFileName <> ".." _
                  ...
                  strInputFP = gstrRawEDIDir & "\" & strFileName
                  ...
                  strFileStamped = strFileName & "(" & strTimeStamp & ")"
                  strDesArcFp = gstrRawEDIArch & "\" & strFileStamped
                  FileCopy strInputFP, strDesArcFp
