...
Begin VB.Form PoItemComments 
   ...
   Begin VB.CommandButton cmdHlp 
      ...
      Height          =   250
      Left            =   0
      Picture         =   "PoItemComments.frx":0000
      Style           =   1  'Graphical
      TabIndex        =   9
      TabStop         =   0   'False
   ...
   Begin VB.CommandButton cmdComments 
      DownPicture     =   "PoItemComments.frx":07AE
      Enabled         =   0   'False
      Height          =   320
      Index           =   6
      Left            =   5280
      Picture         =   "PoItemComments.frx":0C88
      Style           =   1  'Graphical
      TabIndex        =   8
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "PoItemComments"
...
Attribute VB_Exposed = False
   ...
   Private Sub GetItemComment()
      Exit Sub    ' comment already loaded
...
Private Sub txtCmt_KeyPress(KeyAscii As Integer)
   KeyAscii = 0 ' dont allow edit
End Sub

   Private Sub txtCmt_LostFocus()
      ' UPDATE NOT ALLOWED.  KEYPRESS EVENT DISABLES
