...
Begin VB.Form DockODp04a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "On Dock Inspections By Inspector"
   ClientHeight    =   3495
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   7260
   ...
   Begin VB.ComboBox cmbIns 
      ...
      TabIndex        =   0
      Tag             =   "8"
      ToolTipText     =   "Contains Inspectors With On Dock Inspectons"
      Top             =   1080
      Width           =   1665
   End
...
Private Sub FillCombo()
   ...
   sSql = "SELECT DISTINCT PIONDOCKINSPECTOR " _
          & "FROM PoitTable WHERE PIONDOCKINSPECTOR<>''"
...
Private Sub Form_Unload(Cancel As Integer)
   FormUnload
   Set DockODp04a = Nothing
   
End Sub

Private Sub PrintReport()
   Dim sInspRef As String
   ...
   On Error GoTo DiaErr1
   sCustomReport = GetCustomReport("quaod04")
   ...
   sSql = "{PohdTable.POVENDOR} LIKE '" & sVendRef & "*' AND " _
          & "{PoitTable.PIONDOCKINSPECTOR}='" & sInspRef & "' AND " _
...
Private Sub SaveOptions()
   ...
   SaveSetting "Esi2000", "EsiQual", "od04", Trim(sOptions)
...
Private Sub GetOptions()
   Dim sOptions As String
   On Error Resume Next
   sOptions = GetSetting("Esi2000", "EsiQual", "od04", Trim(sOptions))
