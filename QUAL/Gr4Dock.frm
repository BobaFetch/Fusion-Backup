...
Begin VB.Form zGr4Dock 
   ...
   ClientWidth     =   4920
   ControlBox      =   0   'False
   Icon            =   "Gr4Dock.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "Gr4Dock.frx":08CA
   ScaleHeight     =   4515
   ScaleWidth      =   4920
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr4Dock.frx":1194
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr4Dock.frx":174A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr4Dock.frx":1B54
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr4Dock.frx":1CB2
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   3
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr4Dock.frx":258E
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr4Dock.frx":2A3D
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr4Dock.frx":2EDE
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub FillEdit()
   ActiveTab = "E"
   lstSelect.Clear
   If Secure.UserQualG4E = 1 Then
      'If User.Group4 Then
      lstSelect.AddItem "On Dock (Receiving) Inspection"
      lstSelect.AddItem "On Dock (Delivered)"
      lstSelect.AddItem "Set On Dock Requirements"
...
Private Sub FillView()
   ActiveTab = "V"
   lstSelect.Clear
   If Secure.UserQualG4V = 1 Then
      'If User.Group4 Then
      lstSelect.AddItem "Parts Requiring On Dock Inspection"
      lstSelect.AddItem "Parts On Dock (Delivered)"
      lstSelect.AddItem "Acceptance And Rejections By Vendor"
      lstSelect.AddItem "On Dock Inspections By Inspector"
      lstSelect.Enabled = True
      '        Else
      '            lstSelect.Enabled = False
      '            lstSelect.AddItem "No Group Permissions"
...
Public Sub FillFunctions()
   ActiveTab = "F"
   lstSelect.Clear
   If Secure.UserQualG4F = 1 Then
      'If User.Group4 Then
      lstSelect.AddItem "Cancel An On Dock Inspection"
