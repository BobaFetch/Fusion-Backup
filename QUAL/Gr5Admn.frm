...
Begin VB.Form zGr5Admn 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Quality Administration"
   ClientHeight    =   4515
   ClientLeft      =   30
   ClientTop       =   330
   ClientWidth     =   4920
   ControlBox      =   0   'False
   Icon            =   "Gr5Admn.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "Gr5Admn.frx":08CA
   ScaleHeight     =   4515
   ScaleWidth      =   4920
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Admn.frx":1194
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Admn.frx":174A
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Admn.frx":1B54
            Key             =   ""
         EndProperty
         BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Admn.frx":1CB2
            Key             =   ""
         EndProperty
      EndProperty
   End
   ...
   Begin MSComctlLib.ImageList ImageList2 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         NumListImages   =   3
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Admn.frx":258E
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Admn.frx":2A3D
            Key             =   ""
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Gr5Admn.frx":2EDE
            Key             =   ""
         EndProperty
      EndProperty
   End
...
Private Sub FillEdit()
   ActiveTab = "E"
   lstSelect.Clear
   If Secure.UserQualG5E = 1 Then
      'If User.Group5 Then
      lstSelect.AddItem "Customer Information "
      lstSelect.AddItem "Vendor Information "
      lstSelect.AddItem "Part Numbers "
...
Private Sub FillView()
   ActiveTab = "V"
   lstSelect.Clear
   If Secure.UserQualG5V = 1 Then
      'If User.Group5 Then
      lstSelect.AddItem "Customer List "
      lstSelect.AddItem "Customer Directory "
      lstSelect.AddItem "Vendor List "
      lstSelect.AddItem "Vendor Directory "
      lstSelect.AddItem "Vendor Approval List"
      lstSelect.AddItem "Parts By Part Number "
      lstSelect.AddItem "Parts By Part Description "
...
Public Sub FillFunctions()
   ActiveTab = "F"
   lstSelect.Clear
   If Secure.UserQualG5F = 1 Then
      'If User.Group5 Then
      'lstSelect.AddItem "No Group Functions"
      lstSelect.AddItem "Cert UserAccess Manager"
      lstSelect.Enabled = True
      '        Else
      '            lstSelect.Enabled = False
      '            lstSelect.AddItem "No Group Permissions"
