...
Begin VB.Form InspRTf03a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Deactivate An Inspector"
   ClientHeight    =   2130
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5520
   ...
   Begin VB.CommandButton cmdDel 
      ...
      Left            =   4560
      TabIndex        =   4
      ToolTipText     =   "Deactivate This Inspector"
      Top             =   600
      Width           =   875
   End
...
Private Sub DeactivateInspector()
   Dim bResponse As Byte
   Dim sMsg As String
   
   sMsg = "You Are Requesting To Deactivate This " & vbCr _
   ...
   If bResponse = vbYes Then
      ...
      sSql = "UPDATE RinsTable SET INSACTIVE=0 " _
             & "WHERE INSID='" & Compress(cmbIns) & "'"
      clsADOCon.ExecuteSQL sSql
      If clsADOCon.ADOErrNum = 0 Then
         MsgBox cmbIns & " Inspector Is Inactive.", _
         ...
         FillInspectors
      Else
         MsgBox "Could Not Deactivate The Inspector.", _
            vbExclamation, Caption
      End If
   Else
      CancelTrans
