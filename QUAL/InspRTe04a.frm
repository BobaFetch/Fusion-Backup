...
Begin VB.Form InspRTe04a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Responsibility Codes"
   ClientHeight    =   2190
   ClientLeft      =   2385
   ClientTop       =   1680
   ClientWidth     =   5745
   ...
   Begin VB.ComboBox cmbCde 
      ...
      Sorted          =   -1  'True
      TabIndex        =   0
      ToolTipText     =   "Select Or Add Responsibility Code (12 Char Max)"
      Top             =   450
      Width           =   1675
   End
...
Private Sub AddCode()
   ...
   'RdoCde.Close
   On Error GoTo DiaErr1
   sSql = "INSERT INTO RjrsTable (RESREF,RESNUM) " _
          & "VALUES('" & sNewCode & "','" & Trim(cmbCde) _
          & "')"
...
DiaErr1:
   ...
   Resume DiaErr2
DiaErr2:
   MsgBox "Couldn't Add Responsibility Code.", _
