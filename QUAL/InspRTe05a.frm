...
Begin VB.Form InspRTe05a 
   ...
   Begin VB.ComboBox cmbCde 
      ...
      Sorted          =   -1  'True
      TabIndex        =   0
      ToolTipText     =   "Disposition Code (12 Char Max)"
      Top             =   450
      Width           =   1675
   End
...
Private Sub AddCode()
   ...
   'RdoCde.Close
   '10/29/02
   ' sSql = "Select * FROM RjdsTable"
   ' bSqlRows = GetDataSet(RdoCde, ES_KEYSET)
   ' RdoCde.AddNew
   ' RdoCde!DISREF = "" & sNewCode
   ' RdoCde!DISNUM = "" & cmbCde
   ' RdoCde.Update
   Err.Clear
   clsADOCon.ADOErrNum = 0
   sSql = "INSERT INTO RjdsTable (DISREF,DISNUM) " _
          & "VALUES('" & sNewCode & "','" _
          & cmbCde & "')"
...
DiaErr1:
   ...
   Resume DiaErr2
DiaErr2:
   MsgBox "Couldn't Add Disposition Code.", _
      vbExclamation, Caption
   DoModuleErrors Me
