Attribute VB_Name = "ScrollMouseWHeel"
Option Explicit
...
Public Sub FlexGridScroll(ByRef grid As MSFlexGrid, ByVal MouseKeys As Long, ByVal Rotation As Long, ByVal Xpos As Long, ByVal Ypos As Long)
