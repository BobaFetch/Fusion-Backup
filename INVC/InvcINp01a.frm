...
Begin VB.Form InvcINp01a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Parts By Part Number"
   ClientHeight    =   3735
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   7860
   ...
   Begin VB.CommandButton cmdFnd 
      DownPicture     =   "InvcINp01a.frx":07AE
      Height          =   315
      Left            =   5520
      Picture         =   "InvcINp01a.frx":0AF0
      Style           =   1  'Graphical
      TabIndex        =   27
      TabStop         =   0   'False
   ...
   Begin VB.Label z1 
      BackStyle       =   0  'Transparent
      Caption         =   "Parts Without Prod Codes"
      Height          =   285
      Index           =   9
      Left            =   240
      TabIndex        =   31
...
Private Sub PrintReport()
   ...
   If txtCde <> "ALL" Then sCode = Compress(txtCde)
    ...
    sSql = "'Includes Part(s) " & cmbPrt & "... Part Type(s) "
    For iList = 1 To 7
...
Private Sub optCode_Click()
   If optCode.Value = vbChecked Then txtCde = "ALL"
   
End Sub

Private Sub optCode_KeyPress(KeyAscii As Integer)
   KeyLock KeyAscii
