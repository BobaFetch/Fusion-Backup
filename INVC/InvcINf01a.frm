...
Begin VB.Form InvcINf01a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Delete A Part Number"
   ClientHeight    =   2220
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   6240
...
Private Sub FillCombo()
   ...
   MouseCursor 13
   cmbPrt.Clear
   sSql = "SELECT PartTable.PARTREF FROM PartTable LEFT JOIN " _
          & "RunsTable ON PartTable.PARTREF=RunsTable.RUNREF " _
          & "WHERE (RunsTable.RUNREF Is Null AND PartTable.PATOOL=0) " _
