...
Private Sub PrintReport()
   ...
   If txtSplit <> "ALL" Then sSplit = txtSplit
   ...
   aFormulaValue.Add CStr("' Split Comment " & CStr(txtSplit) & "...'")
   aFormulaValue.Add CStr("'Requested By: " & CStr(sInitials) & "'")
   aFormulaValue.Add optDet.Value
   sCustomReport = GetCustomReport("invlt04")
   ...
   sSql = "{LohdTable.LOTSPLITCOMMENT} LIKE '" & sSplit & "*' AND " _
          & "{LohdTable.LOTADATE} in Date(" & sBegDate & ") " _
          & "to Date(" & sEndDate & ")"
   sSql = sSql & " and {LohdTable.LOTSPLITCOMMENT}<> ''"
...
Private Sub SaveOptions()
   SaveSetting "Esi2000", "EsiInvc", "lt04", optDet.Value
...
Private Sub GetOptions()
   ...
   On Error Resume Next
   sOptions = GetSetting("Esi2000", "EsiInvc", "lt04", sOptions)
