...
Begin VB.Form CyclCYf03a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Unlock A Cycle Count"
   ClientHeight    =   2340
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5265
   ...
   Begin VB.CommandButton cmdDel 
      ...
      Left            =   4320
      TabIndex        =   8
      ToolTipText     =   "Unlock This Cycle Count ID"
      Top             =   480
      Width           =   875
   End
...
Private Function GetCycleCount() As Byte
   ...
   Else
      GetCycleCount = 0
      MsgBox "That Count ID Wasn't Found Or Isn't Locked.", _
...
Private Sub cmdDel_Click()
   ...
   Dim sMsg As String
   sMsg = "This Cycle Count Has Been Locked." & vbCr _
          & "Unlock This Cycle ID."
   bResponse = MsgBox(sMsg, ES_NOQUESTION, Caption)
   If bResponse = vbYes Then UnlockCount Else CancelTrans
...
Private Sub FillCombo()
   On Error GoTo DiaErr1
   cmbCid.Clear
   sSql = "SELECT CCREF FROM CchdTable WHERE CCCOUNTLOCKED=1 " _
          & "AND CCUPDATED=0"
   ...
   If cmbCid.ListCount > 0 Then
      ...
      'bGoodCount = GetCycleCount()
   Else
      MsgBox "There Are Unlocked Counts Recorded.", _
         vbInformation, Caption
      Unload Me
   End If
   Exit Sub
...
Private Sub UnlockCount()
   On Error Resume Next
   clsADOCon.ADOErrNum = 0
   clsADOCon.BeginTrans
   
   sSql = "Update CchdTable SET CCCOUNTLOCKEDDATE=Null," _
          & "CCCOUNTLOCKED=0 WHERE CCREF='" & Trim(cmbCid) & "'"
   ...
   If clsADOCon.ADOErrNum = 0 Then
      ...
      MsgBox cmbCid & " Was Successfully Unlocked.", _
         vbInformation, Caption
      FillCombo
   Else
      ...
      MsgBox "Could Not Successfully Unlock " & cmbCid & ".", _
