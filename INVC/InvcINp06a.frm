...
Begin VB.Form InvcINp06a 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "E-Commerce Parts"
   ClientHeight    =   2355
   ClientLeft      =   2115
   ClientTop       =   1125
   ClientWidth     =   7260
   ...
   Begin VB.CommandButton cmdFnd 
      DownPicture     =   "InvcINp06a.frx":07AE
      Height          =   315
      Left            =   4800
      Picture         =   "InvcINp06a.frx":0AF0
      Style           =   1  'Graphical
      TabIndex        =   11
      TabStop         =   0   'False
...
Private Sub PrintReport()
   ...
   sCustomReport = GetCustomReport("inval02")
   ...
   sSql = sSql & " and {PartTable.PAECOMMERCE} = 1.000"
